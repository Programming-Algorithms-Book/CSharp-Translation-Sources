namespace HashSet
{
    ...
    {
        // Стъпка на увеличаване при колизия
        private const int Step = 107;

        // Максимално ниво на запълване
        private const double MaxFillLevel = 0.8;

        // Начален размер на хеш-таблицата
        private static ulong n = 32;
        ...
        private static ulong HashFunction(string key)
        {
            ulong result = 0;
        ...
        private static int Get(string key, out ulong index)
        {
        ...
        private static void Put(string key)
        {
            ...
            // Думата не е в хеш-таблицата
            if (Get(key, out index) == 0)
            {
