...
{
    private static readonly bool? NOT_CALCULATED = null;
    private const int LETTS = 3; /* Брой букви */

    /* Таблица на умножение */

    private static char[,] rel =
    {
        { 'b', 'b', 'a' },
        { 'c', 'b', 'a' },
        { 'a', 'c', 'c' }
    ...
    private static bool?[,,] table = new bool?[s.Length, s.Length, LETTS];
