...
{
    private const int COST_DELETE = 1;
    private const int COST_INSERT = 2;

    private static string s1 = "_abracadabra"; /* Изходен низ (първият символ няма значение) */
    private static string s2 = "_mabragabra"; /* Низ-цел (първият символ няма значение) */
    private static int n1 = s1.Length - 1; /* Дължина на първия низ */
    private static int n2 = s2.Length - 1; /* Дължина на втория низ */

    private static int[,] f = new int[n1 + 1, n2 + 1]; /* Целева функция */
