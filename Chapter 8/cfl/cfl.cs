...
internal class cfl
{
    private struct Production /* Продукции, отиващи в терминали: S->a */
    {
        public char S { get; set; }
        public char A { get; set; }
    }

    private struct NonTerminalProduction /* Продукции, отиващи в нетерминали: S->AB */
    {
        public char S { get; set; }
        public char A { get; set; }
    ...
    private static bool[,,] t = new bool[LettersCount, Max, Max]; /* Целева функция */
