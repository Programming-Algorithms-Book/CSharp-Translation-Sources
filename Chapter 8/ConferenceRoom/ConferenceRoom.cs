...
{
    private struct BeginEnd
    {
        public int Begin { get; set; }
        public int End { get; set; }
    }

    private struct BlueRed
    {
    ...
    private static BlueRed[] B = new BlueRed[MAXD + 1];
    private static BlueRed[] R = new BlueRed[MAXD + 1];

    private static BeginEnd[] blueOrders = new[]
                                           {
                                               new BeginEnd { Begin = 1, End = 5 },
                                               new BeginEnd { Begin = 12, End = 20 }
                                           };

    private static BeginEnd[] redOrders = new[]
                                          {
