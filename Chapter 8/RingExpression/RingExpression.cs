...
internal class Program
{
    ...
    private static long[] x = new long[] { 0, 9, -3, 8, 7, -8, 0, 7 }; /* Стойности на числата (без първото) */
    private static char[] sign = new char[] { ' ', '+', '*', '*', '-', '+', '*', '-' }; /* Знаци между тях */
    private static readonly int n = x.Length - 1; /* Брой числа */
    private static Goal[,] f = new Goal[n + 1, n + 1]; /* Целеви функции Fmin() и Fmax() */
