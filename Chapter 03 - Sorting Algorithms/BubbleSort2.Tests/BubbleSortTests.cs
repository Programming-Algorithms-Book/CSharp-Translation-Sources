namespace BubbleSort2.Tests
{
    ...
    public class BubbleSortTests
    {
        ...
        {
            BubbleSortingAlgorithm2.BubbleSort(null);
        }
        ...
        public void BubbleSortEmptyElementsShouldNotSort()
        {
            ...
            BubbleSortingAlgorithm2.BubbleSort(elements);
        ...
        public void BubbleSortRandomElementsSholdSortCorrectly()
        {
            ...
            {
                BubbleSortingAlgorithm2.Initialize(elements);
                BubbleSortingAlgorithm2.BubbleSort(elements);
                CheckSortingOrder(elements);
            }
        }
